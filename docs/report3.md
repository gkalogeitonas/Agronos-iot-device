...
Η παρούσα αναφορά εστιάζει αποκλειστικά στο υποσύστημα των IoT κόμβων (Device Nodes) της πλατφόρμας **Agronos**. Περιγράφει την αρχιτεκτονική του υλικολογισμικού (firmware) που αναπτύχθηκε για τον μικροελεγκτή ESP32, τις μεθόδους επικοινωνίας και τη στρατηγική  για την αξιόπιστη αποστολή δεδομένων.
...
Η παρούσα αναφορά επεκτείνει την παραπάνω λειτουργικότητα, εισάγοντας προηγμένες δυνατότητες όπως το πρωτόκολλο MQTT, τη διαχείριση ενέργειας (Deep Sleep), τη δυναμική ρύθμιση παραμέτρων (Runtime Configuration) μέσω του Captive Portal.
